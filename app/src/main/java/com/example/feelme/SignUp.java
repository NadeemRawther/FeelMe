...
brotherimgb=((BitmapDrawable)brotherimg.getDrawable()).getBitmap();
        String phonefather,phoneaunt,phoneuncle,phonegrandfather,phonegrandmother,phonebrother,phonesister,phonemother;
...
public void adduser()
{
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == PICK_IMAGE_FATHER && resultCode == RESULT_OK
